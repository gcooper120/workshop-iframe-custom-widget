 ...
 */
export type IVariableType_WithDefaultValue = IVariableType_String_WithDefaultValue | IVariableType_Boolean_WithDefaultValue | IVariableType_Number_WithDefaultValue | IVariableType_Date_WithDefaultValue | IVariableType_Timestamp_WithDefaultValue | IVariableType_StringList_WithDefaultValue | IVariableType_BooleanList_WithDefaultValue | IVariableType_NumberList_WithDefaultValue | IVariableType_DateList_WithDefaultValue | IVariableType_TimestampList_WithDefaultValue | IVariableType_ObjectSet_WithDefaultValue;
export type IStructVariableFieldType_WithDefaultValue = IVariableType_String_WithDefaultValue | IVariableType_Boolean_WithDefaultValue | IVariableType_Number_WithDefaultValue | IVariableType_Date_WithDefaultValue | IVariableType_Timestamp_WithDefaultValue | IVariableType_StringList_WithDefaultValue | IVariableType_BooleanList_WithDefaultValue | IVariableType_NumberList_WithDefaultValue | IVariableType_DateList_WithDefaultValue | IVariableType_TimestampList_WithDefaultValue | IVariableType_ObjectSet_WithDefaultValue;
...
//# sourceMappingURL=variableTypeWithDefaultValue.d.ts.map